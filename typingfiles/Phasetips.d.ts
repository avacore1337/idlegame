// Type definitions for public/Phasetips.js
...
declare interface Paramdata {
	...
	animationSpeedShow : number;

	animationSpeedHide : number;
...
declare class Phasetips {

	constructor (localGame : any, options : Paramdata);
